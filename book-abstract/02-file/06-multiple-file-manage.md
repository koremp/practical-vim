...
- [6장 여러 파일 관리하기](#6장-여러-파일-관리하기)
  - [Tip.37 버퍼 목록으로 열린 파일 추적하기](#tip37-버퍼-목록으로-열린-파일-추적하기)
    - [파일과 버퍼의 차이점 이해하기](#파일과-버퍼의-차이점-이해하기)
    - [버퍼 목록 만나기](#버퍼-목록-만나기)
    - [버퍼 목록 사용하기](#버퍼-목록-사용하기)
    - [버퍼 제거하기](#버퍼-제거하기)
  - [Tip.38 인자 목록으로 버퍼 묶음 관리하기](#tip38-인자-목록으로-버퍼-묶음-관리하기)
    - [인자 목록 출력하기](#인자-목록-출력하기)
    - [이름으로 파일 지정하기](#이름으로-파일-지정하기)
    - [글롭(Glob)으로 파일 지정하기](#글롭glob으로-파일-지정하기)
    - [역따옴표 확장으로 파일 지정하기](#역따옴표-확장으로-파일-지정하기)
    - [인자 목록 사용하기](#인자-목록-사용하기)
  - [Tip.39 숨김 파일 관리하기](#tip39-숨김-파일-관리하기)
    - [종료할 때 숨김 버퍼 처리하기](#종료할-때-숨김-버퍼-처리하기)
    - [:\*do 명령을 사용하기 전에 'hidden' 설정 활성화하기](#do-명령을-사용하기-전에-hidden-설정-활성화하기)
  - [Tip.40 작업 환경 창 분리하기](#tip40-작업-환경-창-분리하기)
    - [분할 창 생성하기](#분할-창-생성하기)
    - [활성화 창 변경하기](#활성화-창-변경하기)
    - [창 닫기](#창-닫기)
    - [창 크기 조절 및 재 정렬](#창-크기-조절-및-재-정렬)
  - [Tip.41 탭으로 창 레이아웃 관리하기](#tip41-탭으로-창-레이아웃-관리하기)
    - [탭을 사용하는 방법](#탭을-사용하는-방법)
    - [탭 열고 닫기](#탭-열고-닫기)
    - [탭 이동하기](#탭-이동하기)
    - [탭 다시 정렬하기](#탭-다시-정렬하기)
